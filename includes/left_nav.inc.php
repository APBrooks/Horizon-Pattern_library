...
<div class="col-md-3 left-nav">
	<div class="list-group" id="accordion" role="tablist" aria-multiselectable="true">
		...
		<a role="button" class="list-group-item active open" data-toggle="collapse" data-parent="#accordion" href="#collapseForms" aria-expanded="false" aria-controls="collapseForms">
		...
		<div id="collapseForms" class="panel-collapse collapse in" role="tabpanel" aria-labelledby="headingOne">
			  ...
			  <a href="multiselect-kendo.php" class="list-group-item">MultiSelect - Kendo</a>
